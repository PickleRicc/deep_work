...
export default async function BehaviorPage() {
    ...
    return (
        <div className="space-y-8 px-4 md:px-8 lg:px-12 py-8 max-w-7xl mx-auto">
            <div>
                <h1 className="text-4xl font-bold text-white">Behavior Tracking</h1>
                <p className="text-gray-400 mt-1">Understand what rewards you</p>
            </div>
